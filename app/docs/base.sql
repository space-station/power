...
INSERT INTO `powers` VALUES (2498,0,'系统管理','el-icon-setting',1,1,'',1,'',1,1565919668475),
(2499,2498,'资源配置','',0,2,'system/resources',1,'',1,1565919806729),
(2500,2499,'获取资源列表','',0,3,'resources/list',1,'',1,1565920383241),
(2501,2499,'添加资源','',0,3,'resources/create',1,'',1,1565946277581),
(2502,2499,'修改资源','',0,3,'resources/modify',1,'',1,1565946972377),
(2504,2498,'角色管理','',0,2,'system/role',1,'',1,1566208216684),
(2505,2499,'删除资源','',0,3,'resources/remove',1,'',1,1566208328995),
(2506,2504,'创建角色','',0,3,'role/create',1,'',1,1566264529914),
(2507,2504,'修改角色','',0,3,'role/modify',1,'',1,1566264817682),
(2508,2504,'删除角色','',0,3,'role/remove',1,'',1,1566264845142),
(2509,2504,'查询角色列表','',0,3,'role/list',1,'',1,1566264881895),
(2510,2504,'查询角色权限','',0,3,'role/powers',1,'',1,1566264918104),
(2511,2504,'修改角色权限','',0,3,'role/modifyPowers',1,'',1,1566264954048),
(2512,2498,'用户管理','',0,2,'system/user',1,'',1,1566264989108),
(2513,2512,'创建用户','',0,3,'user/create',1,'',1,1566265017389),
(2514,2512,'修改用户','',0,3,'user/modify',1,'',1,1566265037191),
(2515,2512,'修改用户密码','',0,3,'user/modifyPwd',1,'',1,1566265072766),
(2516,2512,'删除用户','',0,3,'user/remove',1,'',1,1566265093685),
(2517,2512,'查询用户列表','',0,3,'user/list',1,'',1,1566265120936),
(2518,2512,'查询角色列表','',0,3,'user/roles',1,'供创建用户时选择角色',1,1566265241398),
...
(2522,2521,'文件解析','',0,3,'fileSystem/parse',1,'',1,1566289057462);
...
INSERT INTO `rolePower` VALUES (2572,2498,2498),(2573,2498,2499),(2574,2498,2500),
(2575,2498,2501),(2576,2498,2502),(2577,2498,2505),(2578,2498,2504),(2579,2498,2506),
(2580,2498,2507),(2581,2498,2508),(2582,2498,2509),(2583,2498,2510),(2584,2498,2511),
(2585,2498,2512),(2586,2498,2513),(2587,2498,2514),(2588,2498,2515),(2589,2498,2516),
(2590,2498,2517),(2591,2498,2518),(2592,2498,2519),(2593,2498,2520),(2594,2498,2521),(2595,2498,2522);
...
INSERT INTO `users` VALUES (2498,2498,'baoling','efe6398127928f1b2e9ef3207fb82663','baoling','','',1,'',1,1566034826731);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES (2499,2498,'admin','efe6398127928f1b2e9ef3207fb82663','杨夫贺','','',1,'',1,1566034826731);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
